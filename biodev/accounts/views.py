...
from biodev.settings import DEFAULT_PASSWORD
...
def account_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form = form.save()
            messages.success(request, 'Registrado com sucesso. Entre em contato com o administrador da aplicação para mais detales.')
